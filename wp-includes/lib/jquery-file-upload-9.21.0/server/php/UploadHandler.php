...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null, $orderID = "") {

        $upload_dir = dirname($this->get_server_var('SCRIPT_FILENAME')).'/../../../../../wp-content/uploads/order_attachment/';
        $upload_url = '/wp-content/uploads/order_attachment/';
        if($orderID != ""){
            $upload_dir = $upload_dir . $orderID . '/';
            $upload_url = $upload_url . $orderID . '/';
        }
