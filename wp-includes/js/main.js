...
function getOrderCustomerInfoFormHTML(afterbuyUserID = '') {
    ...
    let htmlTxt = '<div class="col-md-6" id="form-wrap-rechnungsanschrift">\n' +
        ...
        '                                    <select id="KBundesland-RA" class="form-control" style="border-radius: 3px;"></select>\n' +
        '                                </div>\n' +
        '                            </div>\n' +
        '                            <div class="form-group">\n' +
        ...
        '                                    <select id="KBundesland-LA" class="form-control" style="border-radius: 3px;" disabled=""></select>\n' +
        '                                </div>\n' +
        '                            </div>\n' +
        '                            <div class="form-group">\n' +
