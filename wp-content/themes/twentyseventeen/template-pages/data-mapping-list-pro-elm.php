<?php
/* Template Name: Idealhit Datenmapping Liste Pro-Elm Page */
/**
 * Created by PhpStorm.
 * User: ywang
 * Date: 2018/3/19
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Products <=> Elements Mapping-Liste
            <small>Herzlich willkommen bei GoodOne Rechnungsplattform</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="/"><i class="fa fa-dashboard"></i>&nbsp;Home</a></li>
            <li>Ersatzteil</li>
            <li class="active">Mapping Liste ( Pro <=> Elm )</li>
        </ol>
    </section>
            ...
            <div id="cPanel" class="col-md-12">
                ...
                <div class="box box-primary" style="padding: 10px;">
                    <div class="box-header">
                        <h3 class="box-title" style="font-weight: bold;">n&nbsp;x&nbsp;Products&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-exchange"></i>&nbsp;&nbsp;&nbsp;&nbsp;n&nbsp;x&nbsp;Elements</h3>
                    </div>
                    ...
                    <div class="row" style="padding: 10px 20px; display: none;">
                        <div id="cPanel" class="col-md-6">
                            <div class="box box-primary" style="padding: 10px;">
                                <div class="box-header">
                                    <h3 class="box-title">Nach Productsname oder -ean suchen</h3>
                                </div>
                                <div class="box-body">
                                    000
                                </div>
