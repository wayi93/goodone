<?php
/* Template Name: Idealhit Datenmapping Lager Bearbeiten Page */
/**
 * Created by PhpStorm.
 * User: ywang
 * Date: 2018/3/19
            ...
            <div id="cPanel" class="col-md-6">
                ...
                <div class="box box-primary" style="padding: 10px;">
                    <div class="box-header">
                        ...
                        <div class="row">
                            <div class="col-md-4"><h3 class="box-title"><b>1</b> x Regal</h3></div>
                    ...
                    <div class="box-body box-profile">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="margin-b-10">
                                    <input class="form-control" id="mapping-elm-ean" placeholder="Regal ID" onkeyup="disableTextArea('tags-wrap-001');" />
                                </div>
                                <div>
                                    <button id="btn-search-mappings-001" type="button" class="btn btn-primary" onclick="searchMappingsByShelfId();">Mappings suchen</button>
                                </div>
                            </div>
                            <div id="tags-wrap-001-div" class="col-md-8">
                                ...
                                <div>
                                    <button id="btn-save-mappings-001" type="button" class="btn btn-primary" onclick="saveShelfMappings(1);" disabled>Speichern</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row" style="color: #46799b;">
                            <div class="col-md-12">
                                <div style="font-size: 16px;">1 x Regal ID:</div>
                                <div id="mappings-001-elm-Details">
                                    N/A
                                </div>
                                <div style="font-size: 16px; padding-top: 10px;">n x Elements Details:</div>
