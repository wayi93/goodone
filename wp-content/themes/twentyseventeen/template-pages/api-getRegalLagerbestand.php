...
if(!is_user_logged_in()){
    ...
    error_log("-----> DUPA: api-getRegalLagerbestand: elements from a CSV file which is generated by a cronjob");
    error_log("-----> DUPA: api-getRegalLagerbestand: wp-content/uploads/data/lagerbestand/dump_element.20XX.XX.XX-06.00.01.csv");
