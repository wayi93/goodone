<?php
/* Template Name: Idealhit Order Page [Backup 2019.06.06] */
/**
 * Created by PhpStorm.
 * User: ywang
 * Date: 2018/3/19
                                ...
                                <div class="col-sm-4 invoice-col">
                                    ...
                                    <?php if($deal_with == 'order'){
                                        ...
                                        if(strlen($order_id_ab) > 5){
                                            echo '<a href="https://farm04.afterbuy.de/afterbuy/auktionsliste.aspx?art=edit&id=' . $order_id_ab . '&rsposition=0&ref=/afterbuy/auktionsliste.aspx" target="_blank">' . $order_id_ab . '&nbsp;<i class="fa fa-link"></i></a>';
                                        }else{
                                            echo $order_id_ab;
                                        }
                                        ?><br>
...
qrcode.makeCode("'.$value.'");
                            ...
                            <div id="order-btn-print-wrap" class="row no-print" style="margin-top: 30px;">
                                <div class="col-xs-12">
                                    ...
                                    if($deal_with == "order" && strlen($order_main_infos->order_id_ab) > 7){
...
echo '</div>
        ...
        if(COUNT($order_poss_db) > 0){
            for($j=0; $j<COUNT($order_poss_db); ++$j){
                ...
                if($helper->checkStrInString('42512429', $ean) || $helper->checkStrInString('777777777777', $ean)){
                    // send Ajax 显示库存
